...
/*
 * Weak aliases for each exception handler to the default handler.
 * Overridable by using the same function name
 * .thumb_set creates a symbol which is an  alias for another symbol
 */
  .weak	NMI_Handler
